...
function list(){
	...
	$.ajax({
		data : {status : status, fdate : fdate, tdate : tdate, csrf_name : csrf_name},
		url : base_url + "Sales_prev/prev_trans_list",
		type : "POST",
		dataType : "JSON",
		success : function(result){	
			$("#div_query_tbl").html(result.data);
		}, error : function(err){
...
function closed($key){
	...
	$.ajax({
		...
		type : "POST",
		dataType : "JSON",
		url : base_url + "Sales_prev/end_day_payment_transaction",
...
function process_end_day(status){
	...
	$.ajax({
		...
		type : "POST",
		dataType : "JSON",
		url : base_url + "Sales_prev/process_end_day",
		beforeSend : function(){
			swal({
				title : "Processing.....",
