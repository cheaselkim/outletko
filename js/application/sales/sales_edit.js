...
function add_item_table(){
  ...
  $("#tbl-products tbody").append("<tr class='item_row_table'>"+
      "<td class='tbl_prod_no' style='width: 4%;'>"+ $("#prod_no").val() +
    "</td><td class='tbl_prod_name' style='width: 14%;'>"+ $("#prod_name").val() +
    "</td><td class='tbl_qty text-center' style='width: 3%;'>"+ $.number($("#qty").val()) +
    "</td><td class='tbl_stock_uom text-center' style='width: 2.5%;'>"+ $("#stock_uom").val() +
    "</td><td class='tbl_reg_price' hidden>"+ $.number($("#reg_price").val(), 2) +
    "</td><td class='tbl_sel_price text-right px-2' style='width: 6%;'>"+ $.number($("#sel_price").val(), 2) +
    ...
    "</td><td class='tbl_total_selling_price text-right px-2'  style='width: 8%;'>"+ $.number($("#total_selling_price").val(), 2) +
    ...
    "</td><td class='text-center text-red remove_item' style='width: 2%;'>"+ "<i class='fa fa-minus-circle remove_item_table' style='color:red;cursor:pointer;' id='remove_item_table'></i>" 
  ...
  $.ajax({
    ...
    success : function(data){
      ...
      for(var x=0; x<data.trans_dtl.length; x++) {  
        ...
        $("#tbl-products tbody").append("<tr class='item_row_table'><td class='tbl_prod_no'  style='width: 4%;'>"+ data.trans_dtl[x]['product_no'] +
          "</td><td class='tbl_prod_name' style='width: 14%;'>"+  data.trans_dtl[x]['product_name'] +
          "</td><td class='tbl_qty text-center' style='width: 3%;'>"+ data.trans_dtl[x]['qty'] +
          "</td><td class='tbl_stock_uom text-center' style='width: 2.5%;'>"+ data.trans_dtl[x]['unit_desc'] +
          "</td><td class='tbl_reg_price' hidden>"+ data.trans_dtl[x]['reg_selling_price'] +
          "</td><td class='tbl_sel_price text-right px-2' style='width: 6%;'>"+ data.trans_dtl[x]['selling_price'] +
          ...
          "</td><td class='tbl_total_selling_price text-right px-2'  style='width: 8%;'>"+ data.trans_dtl[x]['total_selling_price'] +
