            ...
            if (data.trans_hdr[0]['tran_type'] == "5"){
                for(var x=0; x<data.trans_dtl.length; x++) {    
                    ...
                    $("#tbl-sales-products").append("<tr class='sales_row_table cursor-pointer'>"+
                        ...
                        "</td><td class='tbl-prod-name-replace text-left d-none d-lg-table-cell' style='width: 7%;'>" + data.trans_dtl[x]['product_name'] +
                        "</td><td class='tbl-qty-replace text-left' style='width: 2%;'>" + data.trans_dtl[x]['qty'] +
                        "</td><td class='tbl-unit-replace text-left d-none d-lg-table-cell' style='width: 1%;'>" + data.trans_dtl[x]['unit_code'] + 
                        "</td><td class='tbl-unit-price-replace text-left d-none d-lg-table-cell' style='width: 1.5%;'>"+ $.number(data.trans_dtl[x]['cost'],2) + 
                ...
                for(var x=0; x<data.trans_dtl.length; x++) {    
                    ...
                    "</td><td class='tbl_prod_name d-none d-lg-table-cell' style='width: 7%;'>"+ data.trans_dtl[x]['product_name'] +
                    "</td><td class='tbl_qty' style='width: 1.5%;'>"+ $.number(data.trans_dtl[x]['qty'], 2) +
                    "</td><td class='tbl_unit d-none d-lg-table-cell' style='width: 1%;'>"+ data.trans_dtl[x]['unit_code'] +
                    "</td><td class='tbl_currency d-none d-lg-table-cell' style='width: 1.5%;'>"+ $("#currency :selected").text() +
                    "</td><td class='tbl_price d-none d-lg-table-cell' style='width: 2%;'>"+ $.number(data.trans_dtl[x]['cost'], 2) +
...
function add_item_table(){
    ...
    $("#tbl-products tbody").append("<tr class='item_row_table cursor-pointer'>"+
        ...
        "</td><td class='tbl_currency text-left d-none d-lg-table-cell' style='width: 1.5%;'>" + $("#currency :selected").text() +
...
function preview(){
    ...
    $('#tbl-products tbody tr').each(function (row, tr){
        $("#mod-tbl-products tbody").append("<tr class='item_row_table'>"+
            ...
            "</td><td class='tbl_prod_name text-left d-none d-lg-table-cell' style='width: 9%;'>" + $(tr).find(".tbl_prod_name").text() +
            "</td><td class='tbl_qty text-left' style='width: 1.5%;'>" + $.number($(tr).find(".tbl_qty").text(), 2) +
            "</td><td class='tbl_unit text-left d-none d-lg-table-cell' style='width: 1%;'>" + $(tr).find(".tbl_unit").text() + 
            "</td><td class='tbl_currency text-left d-none d-lg-table-cell' style='width: 1.5%;'>" + $(tr).find(".tbl_currency").text() +
            "</td><td class='tbl_price text-left d-none d-lg-table-cell' style='width: 2%;'>"+ $.number($(tr).find(".tbl_price").text(),2) + 
