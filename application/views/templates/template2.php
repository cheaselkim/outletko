          ...
          <div class="container font-size-18" id="div-login-form">
            ...
            <div class="row">
              <div class="col-lg-12 pb-2" style="line-height: 25px;">
                ...
                <small>New member ? <a class="cursor-pointer" id="a_register">Register here</a> </small>
              </div>
            </div>
          ...
          <div class="container font-size-18" id="div-signup-form">
            ...
            <div class="row">
              <div class="col-lg-12 pb-2" style="line-height: 25px;">
                ...
                <small>Already a member ? <a class="cursor-pointer" id="a_login">Login here</a> </small>
              </div>
            </div>
