			...
			<div class="row pt-2" id="div-home">
				...
				<div class="col pad-right">
					<div  class="col-12 col-sm-12 col-md-12 col-lg-12 div-center pt-2 pb-3" id="div-display-products">
						...
						<div class="row">
							<div class="col-12 col-sm-12 col-md-12 col-lg-12">
								<div class="form-control write-post-box font-size-18" style="height: 100px !important;">
					...
					<div  class="col-12 col-sm-12 col-md-12 col-lg-12 div-center py-3" id="div-product-details">
						...
						<div class="row">
							...
							<div class="col-6">
								...
								<br>
								<span class="font-weight-600">Standard Delivery</span><br>
								<span class="ml-2">Seeds are delivered by LBC</span>

								<div class="row mt-15px">
									<div class="col-2 pad-right	">
										<input type="text" class="form-control he-38 text-center textbox-green2 px-1" value="1">
									</div>
