...
<script type="text/javascript" src="<?php echo base_url('js/admin/master_data/business_type/business_type_query.js') ?>"></script>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12">
                ...
                <input type="text" class="form-control" placeholder="Search Product Type..." id="business_type">
            </div>
        </div>
                ...
                <div class="container">
                    <div class="form-group row my-0">
                        <div class="col-lg-10 text-right pt-1">
                            <label class="font-size-18">No. of Business Type : </label>
                        </div>
