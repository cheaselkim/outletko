...
<script type="text/javascript" src="<?php echo base_url('js/admin/user_registry/user_registry_edit.js') ?>"></script>
    ...
    <div class="container">
                        ...
                        <div class="col-xs-12 col-md-2 px-1">
                            ...
                            <div class="input-group mb-3">
                              <div class="input-group-prepend">
                                <span class="input-group-text bg-white border px-1" style='border-radius: 0 !important;border: 1px solid black !important; border-right: 0 !important; color: black !important;height: 35px;'>+63</span>
                              </div>
        ...
        <div class="form-group row pt-3">
            ...
            <div class="col-xs-12 col-md-4">
                <button type="button" class="btn btn-block btn-success btn-height-30 p-0 font-size-18" id="update">Save</button>
            </div>
            <div class="col-xs-12 col-md-4">
