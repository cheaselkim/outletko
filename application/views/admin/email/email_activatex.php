...
<div class="email-body">
    ...
    <section>
        ...
        <article class="pb-3" style="padding-left: 70px;">
            ...
            <br>
            <p style="padding-right: 37px;font-size: 18px;"><a  class='btn btn-orange' style="text-decoration: none;color: white;" target="_blank" >Click Here to Verify Email Addresss</a></p>
            <!-- href="https://www.outletko.com/Store_register/verify?hash=<?php echo $email; ?>&emailid=<?php echo $account_id; ?>" -->
            <br><br>
