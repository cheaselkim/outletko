						...
						<div class="col-9 pad-left py-1">
							<div class="div-prof-details">
								<div class="row">
									...
									<div class="col-12 col-sm-12 col-md-12 col-lg-12 text-right pt-2 text-span-header-clickable">
								...
								<div class="row">
									<div class="col-lg-12 col-md-12 col-sm-12">
										...
										<div class="row pt-4">
											<div class="col-lg-3 col-md-3 col-sm-12"></div>
											<div class="col-lg-3 col-md-3 col-sm-12">
												<button class="btn btn-green2 btn-block text-white " id="save_payment">Save</button>
											</div>
											<div class="col-lg-3 col-md-3 col-sm-12">
