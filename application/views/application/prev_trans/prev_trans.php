...
<script type="text/javascript" src="<?php echo base_url('js/application/prev_trans/prev_trans.js') ?>"></script>
        ...
        <div class="row">
            <div class="col-xs-12 col-md-12 text-date">
                <div class="row">
                    ...
                    <div class="col-8 col-md-2 order-1 order-md-3 d-none d-md-block d-lg-block d-xl-block pl-1">
                        <button class="btn btn-primary btn-block" id='btn_prev_date' data-toggle = 'modal' data-target='#modal_date'> 
                            <span id='span_prev_date'>Prev Date : &nbsp;&nbsp;<?php echo date('m/d/Y', strtotime('-1 day')) ?></span>
                        </button>
                    </div>
                                ...
                                <div class="form-horizontal  px-2 pt-2 pb-1" style="background: #8ac7d1;">
                                    ...
                                    <div class="form-group row mb-0">
                                        <span class="col-3 col-form-label text-sales pr-0" for="text-input">
                                            <span class="cursor-pointer" id="span-discount"><u>Discount</u></span> 
                                    ...
                                    <div class="row">
                                        <div class="col-5 px-0">
                                            ...
                                            <div class="row pt-2">                                                
                                                ...
                                                <div class="col-6 pr-0">
                                                     <!--btn-success-->
                                                    <button class="form-control py-1 btn-success text-white font-weight-bold" style="height: 50px !important;font-size: 25px !important;"   id="save_prev_trans">Save</button> 
                                                </div>                                                
                                            </div>
                                            <div class="row pt-1">
                                            </div>
  ...
  <div class="modal-dialog" style="max-width: 350px;">
    <div class="modal-content">
      ...
      <div class="modal-header py-1">
        <h4 class="modal-title">Enter Transaction Date</h4>
        <button type="button" class="close" data-dismiss="modal">&times;</button>
      </div>

      <!-- Modal body -->
      <div class="modal-body py-2">
        <input type="text" class="form-control cursor-pointer" value="<?php echo date('m/d/Y', strtotime('-1 day')) ?>" id='modal_prev_date' readonly>
      </div>

      <!-- Modal footer -->
      <div class="modal-footer py-1">
        <button type="button" class="btn btn-primary" data-dismiss="modal" id='save_prev_date'>Save</button>
