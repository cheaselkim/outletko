<script type="text/javascript" src="<?php echo base_url('js/application/post_prev_trans/post_prev_trans.js') ?>"></script>
          ...
          <div class="col-xs-12 col-md-12 col-lg-12">
              <div class="row">
                  <div class="col-xs-12 col-md-12 pt-3">
                      <h3 class="font-weight-bold">Post - Previous Transactions</h3>
                  </div>
              </div>
          </div>
      </div>
