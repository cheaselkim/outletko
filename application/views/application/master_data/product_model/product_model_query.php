...
<script type="text/javascript" src="<?php echo base_url('js/application/master_data/product_model/product_model_query.js') ?>"></script>
...
<div class="container-fluid pt-2">
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-2 col-md-12 col-sm-12 pad-right">
            ...
            <div class="col-lg-10 col-md-12 col-sm-12 pad-left">
                <span class="font-size-18">Keyword</span>
                <input type="text" class="form-control" placeholder="Search Product Type..." id="prod_model_desc">
            </div>
        </div>
                ...
                <div class="container">
                    <div class="form-group row my-0">
                        <div class="col-lg-10 text-right pt-1">
                            <label class="font-size-18">No. of Product Model : </label>
                        </div>
