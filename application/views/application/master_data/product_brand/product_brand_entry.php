...
<script type="text/javascript" src="<?php echo base_url('js/application/master_data/product_brand/product_brand_entry.js') ?>"></script>
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-5 col-sm-12 px-0">
                            ...
                            <div class="form-group py-0 my-1">
                                ...
                                <input type="text" class="form-control " id="prod_brand_name">
                            </div>
                            <div class="form-group py-0 my-1">
                                <label class="text-prod">Product Brand Description</label>
                                <input type="text" class="form-control " id="prod_brand_desc">
                            </div>
