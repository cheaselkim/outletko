...
<script type="text/javascript" src="<?php echo base_url('js/application/master_data/product_brand/product_brand_query.js') ?>"></script>
      ...
      <hr style="color: black;" class="mt-0 mb-2">
        ...
        <div class="row">
            ...
            <div class="col-lg-10 col-md-9 col-sm-12  pl-1">
                ...
                <input type="text" class="form-control" placeholder="Search Product Type..." id="prod_brand_desc">
            </div>
        </div>
            ...
            <div class="col-xs-12 col-md-12">
                <div class="container">
                    <div class="form-group row bg-button my-0">
                        <div class="col-xs-12 col-md-4 col-lg-2 py-1 ml-auto pl-0 pr-1">
                ...
                <div class="container">
                    <div class="form-group row my-0">
                        <div class="col-lg-10 col-md-10 text-right pt-1">
                            <label class="font-size-18">No. of Product Brand : </label>
                        </div>
