...
<script type="text/javascript" src="<?php echo base_url('js/application/master_data/product_color/product_color_entry.js') ?>"></script>
<script type="text/javascript" src="<?php echo base_url('js/application/master_data/product_color/product_color_edit.js') ?>"></script>
                ...
                <div class="container" id="div-prod">
                    <div class="col-lg-4 px-0">
                        ...
                        <div class="form-group py-0 my-1">
                            ...
                            <select class="form-control" id="prod_color_outlet">
                                <option value="0">ALL</option>
                            </select>
                        </div>
                        <div class="form-group py-0 my-1">
                            <label class="text-prod">Product Color Code<span class="required">*</span></label>
                            <input type="text" class="form-control text-uppercase" id="prod_color_code">
                        </div>
                        <div class="form-group py-0 my-1">
                            <label class="text-prod">Product Color Name<span class="required">*</span></label>
                            <input type="text" class="form-control text-capitalize " id="prod_color_name">
                        </div>
                        <div class="form-group py-0 my-1" hidden>
                            <label class="text-prod">Product Color Description</label>
                            <input type="text" class="form-control text-uppercase" id="prod_color_desc">
                        </div>
                    </div>
                </div>
            </div>
