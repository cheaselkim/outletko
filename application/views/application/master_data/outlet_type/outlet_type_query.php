...
<script type="text/javascript" src="<?php echo base_url('js/application/master_data/outlet_type/outlet_type_query.js') ?>"></script>
...
<div class="container-fluid pt-2">
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-2 col-md-3 col-sm-12 pad-right" hidden>
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 pad-left">
                <span class="font-size-18">Keyword</span>
                <input type="text" class="form-control" placeholder="Search Outlet Type..." id="outlet_type_desc">
            </div>
        </div>
