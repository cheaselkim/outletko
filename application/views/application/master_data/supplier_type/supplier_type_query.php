...
<script type="text/javascript" src="<?php echo base_url('js/application/master_data/supplier_type/supplier_type_query.js') ?>"></script>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-10 col-md-9 col-sm-12 pl-1">
                ...
                <input type="text" class="form-control" placeholder="Search Product Type..." id="prod_type_desc">
            </div>
        </div>
                ...
                <div class="container">
                    <div class="form-group row bg-button my-0">
                        <div class="col-xs-12 col-md-2 col-lg-2 py-1 ml-auto pl-0 pr-1">
                            <button class="btn btn-success btn-height-30 btn-block p-0">Search</button>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="container">
                    <div class="form-group row my-0">
                        <div class="col-lg-10 col-md-10 text-right pt-1">
                            <label class="font-size-18">No. of Supplier Type : </label>
                        </div>
