...
<script type="text/javascript" src="<?php echo base_url('js/application/master_data/supplier_type/supplier_type_entry.js') ?>"></script>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-12">
                            ...
                            <div class="form-group py-0 my-1">
                                ...
                                <input type="text" class="form-control" id="supp_type_desc">
