<script type="text/javascript" src="<?php echo base_url('js/application/master_data/bank_maintenance/bank_maintenance_entry.js') ?>"></script>
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-4 col-sm-12 px-0">
                            ...
                            <div class="form-group py-0 my-1">
                                ...
                                <input type="text" class="form-control text-uppercase px-2" id="bank_maintenance_code">
                            </div>
                            <div class="form-group py-0 my-1">
                                <label class="text-prod">Bank Name<span class="required">*</span></label>
                                <input type="text" class="form-control px-2" id="bank_maintenance_name">
                            </div>
                            <div class="form-group py-0 my-1" >
                                <label class="text-prod">Account No <span class="required">*</span></label>
                                <input type="text" class="form-control px-2" id="bank_maintenance_account"  onkeypress="return isNumber(event)">
                            </div>
