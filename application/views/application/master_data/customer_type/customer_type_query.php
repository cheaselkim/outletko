...
<script type="text/javascript" src="<?php echo base_url('js/application/master_data/customer_type/customer_type_query.js') ?>"></script>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-10 col-md-9 col-sm-12 pl-1">
                ...
                <input type="text" class="form-control" placeholder="Search Product Type..." id="cust_type_desc">
            </div>
        </div>
