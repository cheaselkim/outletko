...
<script type="text/javascript" src="<?php echo base_url('js/application/master_data/product_class/product_class_query.js') ?>"></script>
...
<div class="container-fluid pt-2">
    <div class="container">
      ...
      <hr style="color: black;" class="mt-0 mb-2">
        ...
        <div class="row">
            <div class="col-lg-2 col-md-2 col-sm-12 pad-right">
              <span class="font-size-18">Class Code</span>               
              <input type="text" class="form-control"  id="prod_class_code">
            </div>
            <div class="col-lg-5 col-md-4 col-sm-12 pad-center">
              <span class="font-size-18">Class Name</span>               
              <input type="text" class="form-control"  id="prod_class_name">
            </div>
            <div class="col-lg-3 col-md-4 col-sm-12 pad-center">
              <span class="font-size-18">Category</span>               
              <select class="form-control" id="prod_class_category">
                <option value="0">ALL</option>
              </select>
            </div>
            <div class="col-lg-2 col-md-2 col-sm-12 pad-left">
                ...
                <div class="container">
                    <div class="form-group row my-0">
                        <div class="col-8 col-lg-10 col-md-10 text-right pt-1">
                            <label class="font-size-18">No. of Product Class : </label>
                        </div>
