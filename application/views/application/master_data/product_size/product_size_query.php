...
<script type="text/javascript" src="<?php echo base_url('js/application/master_data/product_size/product_size_query.js') ?>"></script>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-10 col-md-9 col-sm-12 pl-1">
                ...
                <input type="text" class="form-control" placeholder="Search Product Size..." id="prod_size_desc">
            </div>
        </div>
                ...
                <div class="container">
                    <div class="form-group row my-0">
                        <div class="col-lg-10 col-md-10 text-right pt-1">
                            <label class="font-size-18">No. of Product Size : </label>
                        </div>
