                        ...
                        <table class="table table-striped table-fixed fixed_header text-table table-hover table-sm" id="tbl-products">
                            <thead style="width: 100%;">
                                <tr>
                                    ...
                                    <th style="width: 1.5%;" class="text-left d-none d-lg-table-cell">Currency</th>
            ...
            <div class="col-lg-12 px-0">
                <div class="row">
                    <div class="col-lg-6 pad-left">
                        <button class="btn btn-block btn-danger mt-2" id="sales_replacement_cancel">Cancel</button>
                    </div>
                    <div class="col-lg-6 pad-right">
                        <button class="btn btn-block btn-success mt-2" id="sales_replacement_continue">Continue</button>
                    </div>
                </div>                
            </div>            
        </div>
