            ...
            <div  class="col-xs-12 col-md-12 p-0 m-0">
                <div class="container">
                    ...
                    <div class="form-group row py-1 my-0 mx-0 bg-button">
                        ...
                        <div class="col-xs-12 col-md-2 col-md-2 px-1">
                        ...
                        <div class="col-xs-12 col-md-2 col-md-2 ml-auto pl-1">
                ...
                <div class="container-fluid mx-0 ">
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6 pl-0 text-right">
                            <h3 class="">Issued To <span id="mod_tran_type"></span></h3>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-xs-12 col-md-12">
                    <div class="row">
                        <div class="col-lg-8">
                            ...
                            <div class="form-group row mb-0">
                                <span class="font-weight-600 col-md-2 px-0">Issued To</span>
                            ...
                            <div class="form-group row mb-0" >
                                <span class="font-weight-600 col-md-2">Issued By</span>
                        ...
                        <div class="col-lg-4 px-0">
                            ...
                            <div class="form-group row mb-0">
                                <span class="font-weight-600 col-md-5 px-0">Issuance No.</span>
                            ...
                            <div class="form-group row mb-0">
                                <span class="font-weight-600 col-md-5 px-0">Issuance Date</span>
                                <div class="col-xs-12 col-md-7 pl-0">
                            ...
                            <div class="form-group row mb-0">
                                <span class="font-weight-600 col-md-5 px-0">Issuance Outlet</span>
                                <div class="col-xs-12 col-md-7 pl-0">
