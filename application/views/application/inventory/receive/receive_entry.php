...
<body>
<input type="hidden" id="tbl_item_row" reaodnly>
<input type="hidden" id="account_currency" readonly>
...
<div class="container-fluid pt-2 " id="div-receive-inventory">
    <div class="container">
                ...
                <div class="container text-sales">
                    ...
                    <div class="row mb-0">
                        ...
                        <div class="col-12 col-xs-12 col-md-12 col-lg-4">
                            <div class="form-group row mb-0">  
                                <div class="col-6 col-xs-12 col-md-6 px-1" id="div-type-action">
                        ...
                        <div class="col-12 col-xs-12 col-sm-12 col-md-12 col-lg-4"> 
                            <div class="form-group row mb-0"> 
                                <div class="col-6 col-xs-12 col-md-6 px-1">
                                    ...
                                    <input class="form-control txt-box-text-size" id="trans_no" data-id = "">
                                </div>
                                <div class="col-6 col-xs-12 col-md-6 px-1">
                    ...
                    <div class="row mb-0">
                        <div class="col-12">   
                            <div class="form-group row mb-0">
                                <div class="col-12 col-xs-12 col-md-12 px-1">
                                    <span>Remarks</span>
                ...
                <div class="container">
                    ...
                    <div class="form-group row my-0 mx-0 bg-button">
                        ...
                        <div class="col-xs-12 col-md-2 col-lg-2 pad-right">
                            <button class="btn btn-block btn-danger my-1 btn-exit p-0 btn-prod">Exit</button>
                        </div>
                ...
                <div class="col-xs-12 col-md-12">
                    ...
                    <div class="form-group row mb-0" id="div-prod-tran-type-1" >
                        <div class="col-12 col-xs-12 col-md-2 col-lg-2 px-1">
                            ...
                            <input class="form-control txt-box-text-size" id="prod_no" data-unit="" data-id = "0">
                        </div>
                        ...
                        <div class="table-responsive">
                            ...
                            <table class="table table-striped table-fixed fixed_header text-table table-hover table-sm" id="tbl-products">
                                <thead style="width: 100%;">
                                    <tr>
                                        <th style="width: 2%;" class="text-left">Product No</th>
                                        ...
                                        <th style="width: 1%;" class="text-left d-none d-lg-table-cell">UC</th>
                            ...
                            <table class="table table-striped table-fixed fixed_header text-table table-hover table-sm" id="tbl-sales-products">
                                <thead style="width: 100%;">
                                    <tr>
                                        ...
                                        <th style="width: 2%;" class="text-left" id="rtn_qty">Returned Qty</th>
                            ...
                            <table class="table table-striped table-fixed fixed_header text-table table-hover table-sm" id="tbl-transfer-products" >
                                <thead class="w-100">
                                    <tr>
                                        <th style="width: 2.5%;" class="text-left">Product No</th>
                                        <th style="width: 7%;" class="text-left d-none d-lg-table-cell">Product Name</th>
                                        <th style="width: 2%;" class="text-left" id="iss_qty">Qty Issued</th>
                                        <th style="width: 2%;" class="text-left" id="rcvd_qty">Qty Received</th>
                                        <th style="width: 1.5%;" class="text-left d-none d-lg-table-cell">Unit</th>
...
<!-- Modal for Retrieving Issuance -->
<div class="modal" id="prod_transfer_modal" style="top: 5%;">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-lg-6 mx-auto">
                        <span class="font-weight-600 font-size-18">Please Input Product Issuance No.</span>
                        <input type="text" class="form-control" placeholder="Issuance No..." id="issuance_no">
                    </div>
                </div>
                <div class="row mt-3">
                     <div class="col-lg-6 text-center mx-auto">
                         <button class="btn btn-danger btn-height-35" data-dismiss="modal">Cancel</button>
                         <button class="btn btn-orange btn-height-35" id="prod_transfer_continue">Continue</button>
                     </div>
                </div>
                <div class="row mt-3">
                    <div class="col-lg-12">
                        <div id="div-prod-transfer-tbl" style="height: 350px; overflow: auto;">
...
<!-- END Modal for Retrieving Issuance -->
    ...
    <div class="modal-dialog" style="max-width: 1200px !important;">
        <div class="modal-content">
            ...
            <div class="modal-body pt-0">
                    ...
                    <div class="col-lg-5">
                        <div class="row">
                            ...
                            <div class="col-lg-4 pad-center">
                                ...
                                <input type="text" class="form-control" id="sales_register_cust_code" data-id= "">
                            </div>
                        </div>
                    </div>
                ...
                <div class="row mt-3">
                    <div class="col-lg-12 col-md-12 col-sm-12" >
                        <div style="height: 175px;overflow: auto;border: 1px solid gray;" class='table-responsive' id="sales_register_hdr">
                ...
                <div class="row mt-3">
                    <div class="col-lg-12 col-md-12 col-sm-12" >
                        <div style="height: 225px;overflow:auto;border: 1px solid gray;" class='table-responsive' id="sales_register_dtl">
                ...
                <div class="container-fluid mx-0 ">
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6 pl-0 text-right">
                            <h4 class="">Receiving From <span id="mod_tran_type"></span></h4>
                        </div>
                    </div>
                </div>
            </div>

            <div class="modal-body text-modal pb-0 font-size-16">
                <div class="col-xs-12 col-md-12">
                    <div class="row">
                        <div class="col-lg-8">
                            ...
                            <div class="form-group row mb-0">
                                ...
                                <div class="col-xs-12 col-md-auto pr-0">
                ...
                <div class="col-xs-12 col-md-12">
                    <div class="row" style="padding-right: 10px;"> 
                        ...
                        <table class="table table-striped table-fixed text-table table-sm mb-0 font-size-16" id="mod-tbl-products">
                            <thead class="w-100">
                                <tr>
                                    <th style="width: 2%;" class="text-left">Product No</th>
                                    <th style="width: 8%;" class="text-left d-none d-lg-table-cell">Product Name</th>
...
<!--                                     <th style="width: 1%;" class="text-left">Curr</th> -->
                                    ...
                                    <th style="width: 1%;" class="text-center d-none d-lg-table-cell">VAT</th>
                                    <th style="width: 2%;" class="text-center">Total Price</th>
                                </tr>
                            </thead>
                        ...
                        <table class="table table-striped table-fixed fixed_header text-table table-hover table-sm font-size-16" id="mod-tbl-sales-products">
                            <thead style="width: 100%;">
                                <tr>
                                    <th style="width: 2.5%;" class="text-left">Product No</th>
                                    <th style="width: 7%;" class="text-left d-none d-lg-table-cell">Product Name</th>
