            ...
            <div  class="col-xs-12 col-md-12 p-0 m-0">
                <div class="container">
                    ...
                    <div class="form-group row py-1 my-0 mx-0 bg-button">
                        <div class="col-xs-12 col-md-3 col-lg-3" id="div-btn-item"></div>
                        ...
                        <div class="col-xs-12 col-md-3 col-lg-3 px-1" id="div-sales-register">
                        ...
                        <div class="col-xs-12 col-md-2 col-lg-2 ml-auto pl-1">
                        ...
                        <table class="table table-striped table-fixed fixed_header text-table table-hover table-sm" id="tbl-products">
                            <thead style="width: 100%;">
                                <tr>
                                    ...
                                    <th style="width: 1%;" class="text-left">UC</th>
