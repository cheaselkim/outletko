                        ...
                        <div class="col-8">
                            <div class="form-group row mb-0">
                                <div class="col-xs-12 col-md-3 px-1">
                                    ...
                                    <input class="form-control txt-box-text-size" id="transfer_no">
                                </div>
                                <div class="col-xs-12 col-md-3 px-1">
                                    <span>Transfer Date <span class="required">*</span></span>
                                    <input type="Date" class="form-control txt-box-text-size" id="transfer_date" value="<?php echo date("Y-m-d") ?>">
                                </div>
                                <div class="col-xs-12 col-md-6 px-1">
                                    <span>Transaction Type <span class="required">*</span></span>
                                    <select class="form-control txt-box-text-size" id="transaction_type">
                                        <option>Purchase Transfer Request</option>
                                    </select>
                                </div>
                            </div>    
                        </div>
                ...
                <div class="col-xs-12 col-md-12">
                    <div class="form-group row mb-0">
                        ...
                        <div class="col-xs-12 col-md-3">
                            <div class="form-group row mb-0">
                                <span class="font-weight-bold">Transfer No. : </span>
                                <div class="col-xs-12 col-md-6 pl-2 ">
                        ...
                        <div class="col-xs-12 col-md-3 pr-0">
                            <div class="form-group row mb-0" >
                                <span class="font-weight-bold">Transferred By : </span>
                    ...
                    <div class="form-group row mb-0" >
                        ...
                        <div class="col-xs-12 col-md-3">
                            <div class="form-group row mb-0">
                                <span class="font-weight-bold">Transfer Date : </span>
                                <div class="col-xs-12 col-md-6 pl-2">
