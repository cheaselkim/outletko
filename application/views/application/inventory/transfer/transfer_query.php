...
<script type="text/javascript" src="<?php echo base_url('js/application/inventory/transfer/transfer_query.js') ?>"></script>
          ...
          <div class="col-xs-12 col-md-12 col-lg-12">
              <div class="row">
                  <div class="col-xs-6 col-md-6 pt-3">
                      <h3 class="font-weight-bold">Transfer Inventory</h3>
                  </div>
          ...
          <div class="container">
            <div class="form-group row my-0" >
              <div class="col-xs-12 col-md-2 pr-1 pl-0">
                <label class="text-sales">Transfered Date</label>
                <input type="date" class="form-control txt-box-text-size" value="">
              </div>
          ...
          <div class="container">
            <div class="form-group row my-0">
              <div class="col-lg-10 text-right pt-1">
                <label class="text-sales">No. of Transfered Transaction : </label>
              </div>
              <div class="col-lg-2 text-right px-0">
                <input type="text" class="form-control text-center ml-auto" id="transfer_trans" value="0" readonly>
              </div>
            </div>              
          </div>
        </div>
      ...
      <div class="modal-body">
        <div class="row">
          <div class="col-lg-3 col-md-6 col-sm-12">
            <label class="font-size-modal">Transfer No</label>
            <input type="text" class="form-control" id="mod_transfer_no" readonly>
          </div>
          <div class="col-lg-3 col-md-6 col-sm-12">
            <label class="font-size-modal">Transfer Date</label>
            <input type="date" class="form-control" id="mod_trasnfer_date" readonly>
          </div>
          <div class="col-lg-3 col-md-6 col-sm-12">
        ...
        <div class="row pt-2">
          <div class="col-lg-6">
            <div class="row">
              <div class="col-lg-6">
                <label class="font-size-modal">Average Selling Price</label>
