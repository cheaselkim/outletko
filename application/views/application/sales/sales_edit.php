...
<!--                                             <span class="cursor-pointer" id="dis-info" data-toggle="tooltip" data-placement="bottom"  title="Sr Citizen Discount"><i class="fa fa-info-circle"></i></span> -->
                    ...
                    <div class="col-8 col-md-8 col-lg-8">
                        <div class="row" style="padding-right: 10px;"> 
                                    <table class="table table-bordered table-hover table-bordered table-fixed text-table" id="tbl-products">
                                        <thead class='w-100'>
                                                    <!--<tr>-->
                                        ...
                                        <div class="col-4 ml-auto">
                                            <div class="row">                                                
                                                <div class="col-12 pr-0">
                                                    <!--btn-warning-->
                                                    <button class="form-control btn-warning py-1 font-weight-bold" style="height: 50px !important;font-size: 20px !important" data-toggle="modal" data-target="#preview_modal" onclick="preview_data();">Preview</button>
                                                </div>
                                            </div>
                                            <div class="row pt-1">
                                                <div class="col-12 pr-0">
                ...
                <div class="col-12">
                    <div class="form-group row">
                        <div class="col-3 pr-1">
                            <select class="form-control font-size-18" id="item_category">
                                
                            </select>
                        </div>
                        <div class="col-7 px-1">
                            <input type="text" class="form-control txt-box-text-size font-size-18" placeholder="Search Product Code, Product Name..." aria-label="Recipient's username" aria-describedby="basic-addon2" id="item_keyword">
                        </div>
            ...
            <div class="modal-header pt-2 pb-0">
                <div class="col-xs-12 col-md-12">
                    <div class="form-group row mb-0">
                        ...
                        <button type="button" class="close btn-close-modal" data-dismiss="modal" aria-label="Close" onclick="close_trans_modal()">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                </div>
