<script type="text/javascript" src="<?php echo base_url('js/application/users/user_owner_query.js') ?>"></script>
...
<div class="container-fluid pt-2" id="owner_query">
    ...
    <div class="container">
        ...
        <div class="form-group row pt-3">
            ...
            <div class="col-xs-12 col-md-8">
                ...
                <button type="button" class="btn btn-block btn-orange btn-height-30 p-0 font-size-18 font-weight-bold" id="cancel">Main Menu</button>
