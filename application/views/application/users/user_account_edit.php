                ...
                <div class="container">
                    <div class="form-group row mb-0">
                        ...
                        <div class="col-lg-2 col-md-3 col-sm-12">
                            ...
                            <select class="form-control px-0" id="all_access" disabled>
                        ...
                        <div class="col-lg-2 col-md-3 col-sm-12 px-1">
                            ...
                            <select class="form-control px-0" id="sales_force_type" disabled>
                            </select>
                        </div>
                    ...
                    <div class="form-group row mb-0">
                        <div class="col-xs-12 col-md-4 pr-1">
                            ...
                            <select class="form-control" id="outlet" disabled>
                        ...
                        <div class="col-xs-12 col-md-2 px-1">
                            ...
                            <input type="date" class="form-control" id="date_end" disabled>
                        </div>
                        <div class="col-xs-12 col-md-2 px-1">
                            <span class="font-size-18">Monthly Quota</span>
                            <input type="text" class="form-control text-right" id="monthly_quota" value="0" disabled>
                        </div>
                        <div class="col-xs-12 col-md-2 pl-1">
                            <span class="font-size-18">% of Share (PHP)  </span>
                            <input type="text" class="form-control text-right" id="share" value="0" disabled>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="container">
                    <div class="form-group row">
                        ...
                        <div class="col-xs-12 col-md-4">
                            <button type="button" class="btn btn-block btn-success btn-height-30 font-size-18 p-0 font-weight-bold" id="update">Update</button>
                        </div>
                        <div class="col-xs-12 col-md-4">
