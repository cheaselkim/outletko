  ...
  <body class="app header-fixed sidebar-fixed aside-menu-fixed"> <!--  sidebar-lg-show -->
    <header class="app-header navbar">
      ...
      <a class="navbar-brand" href="#">
        <div class="navbar-brand-full ml-3"> 
          <img  src="<?php echo base_url('assets/img/latest.png') ?>" width="89" height="30" alt="EPGM">
          <span class="ml-2" style="font-size: 18px; color: green;vertical-align: bottom;">| E-bidding Suite</span>
        </div>
        <div class="navbar-brand-minimized ml-5 pl-5">
          <span class="ml-5"></span> 
          <img  class="ml-5" src="<?php echo base_url('assets/img/latest.png') ?>" width="89" height="30" alt="EPGM">
          <span class="ml-2" style="font-size: 18px; color: green;vertical-align: bottom;">| E-bidding Suite</span>
        </div>
      </a>
      <ul class="nav navbar-nav ml-auto mr-5">
        <li class="nav-item dropdown mr-3">
          <a class="nav-link" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">
            <span><i class="icon-organization"></i> Company</span>
          </a>
          <div class="dropdown-menu dropdown-menu-right">
            ...
            <a class="dropdown-item" href="#">
              <span><i class="icon-plus" style="color: orange"></i> Add New</span>
            </a>
          </div>
        </li>
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu dropdown-menu-right">
            <a class="dropdown-item" href="#"><span><i class="icon-lock" style="color: orange;"></i> Change Password</span></a>
            <a class="dropdown-item" href="#"><span><i class="icon-logout" style="color: orange;"></i> Logout</span></a>
          </div>
        </li>
      </ul>
    </header>
